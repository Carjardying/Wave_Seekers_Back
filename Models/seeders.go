...
// SeedUsers insère tous les utilisateurs dans la base de données
...
// SeedCountries insère tous les pays dans la base de données
...
// SeedSpots insère tous les spots dans la base de données
